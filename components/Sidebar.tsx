...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className={`${isCollapsed ? 'w-20' : 'w-64'} border-r border-gray-100 dark:border-slate-800 flex flex-col h-full bg-white/50 dark:bg-slate-950/50 backdrop-blur-xl flex-shrink-0 transition-all duration-300 relative`}>
      <div className={`p-4 flex flex-col h-full ${isCollapsed ? 'items-center' : ''}`}>
        <div
          className={`flex items-center mb-8 ${isCollapsed ? 'flex-col gap-4 justify-center' : 'justify-between'}`}
        >
          <div
        ...
        <div className={`space-y-6 flex-1 overflow-y-auto custom-scrollbar ${isCollapsed ? 'px-0' : '-mx-2 px-2'}`}>
          {/* Main Navigation */}
          <nav className="space-y-1">
            ...
            <button
              ...
              title={isCollapsed ? "Sticky Notes" : undefined}
            ...
            {activeProject && (
              <div className="py-2 space-y-1">
                ...
                {isCollapsed && <div className="h-px bg-gray-100 dark:bg-slate-800 my-2 w-full" />}

                <button
                  onClick={() => onTabChange('backlog')}
                  title={isCollapsed ? "Backlog" : undefined}
                ...
                <button
                  ...
                  title={isCollapsed ? "Sprint Planning" : undefined}
                ...
                <button
                  ...
                  title={isCollapsed ? "Issue List" : undefined}
                ...
                >
                  ...
                  {!isCollapsed && <span>Issue List</span>}
                </button>
                <button
        ...
        <div className={`mt-auto pt-6 border-t border-gray-50 dark:border-slate-900 ${isCollapsed ? 'flex justify-center' : ''}`}>
          <div className={`flex items-center gap-3 px-3 py-2 text-sm text-gray-500 dark:text-slate-400 hover:bg-gray-50 dark:hover:bg-slate-800/50 rounded-xl transition-all cursor-pointer group ${isCollapsed ? 'justify-center' : ''}`}>
